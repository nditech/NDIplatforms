...
libraries[clickatell_sms_provider][download][type] = "git"
libraries[clickatell_sms_provider][download][url] = "https://github.com/veda-consulting/org.civicrm.sms.clickatell.git"
libraries[clickatell_sms_provider][destination] = "modules/civicrm/extensions"

libraries[twilio_sms][download][type] = "git"
libraries[twilio_sms][download][url] = "https://github.com/civicrm/org.civicrm.sms.twilio.git"
libraries[twilio_sms][destination] = "modules/civicrm/extensions"

libraries[mandrill_email][download][type] = "git"
...
libraries[mandrill_email][destination] = "modules/civicrm/extensions"

libraries[civicrm_activity_ical][download][type] = "git"
...
libraries[civicrm_activity_ical][destination] = "modules/civicrm/extensions"

libraries[event_calendar][download][type] = "git"
...
libraries[event_calendar][destination] = "modules/civicrm/extensions"
...
libraries[civisualize][destination] = "modules/civicrm/extensions"
